...
angular.module("fl.ionic-meteor").factory("MeteorHelper", MeteorHelper);
MeteorHelper.$inject = ['$q', '$rootScope'];
function MeteorHelper($q, $rootScope) {
  return {
...
angular.module('fl.ionic-meteor').factory('LoadMoreService', LoadMoreService);
LoadMoreService.$inject = ['$meteor', '$timeout'];
function LoadMoreService($meteor, $timeout) {
